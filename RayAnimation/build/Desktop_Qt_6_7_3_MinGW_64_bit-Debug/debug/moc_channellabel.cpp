/****************************************************************************
** Meta object code from reading C++ file 'channellabel.h'
**
...
#error "The header file 'channellabel.h' doesn't include <QObject>."
...
void ChannelLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ChannelLabel::*)(int );
            if (_t _q_method = &ChannelLabel::ValueChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ChannelLabel::ValueChanged(int _t1)
{
